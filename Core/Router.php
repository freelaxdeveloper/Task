...
class Router
{
    ...
    public function run()
    {
        ...
        if (!isset($controllObject)) {
            $this->access_denied('Не найден подходящий роут для страницы: ' . $this->getURI());
        }
    }
